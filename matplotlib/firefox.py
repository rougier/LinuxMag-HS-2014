...
# Récupérer sur: http://raphaeljs.com/icons/#firefox
...
# On affiche le contour en blanc (épaisseur 6)
patch = patches.PathPatch(path, facecolor='None', edgecolor='w', lw=6)
ax.add_patch(patch)

# On affiche le fond avec un bord noir (épaisseur 2)
...
# On enlève les marques sur les axes
ax.set_xticks([])
ax.set_yticks([])
